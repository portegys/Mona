...
Generate SNNS (Stuttgart Neural Network Simulator)
meta-maze pattern files given a maze_maker maze discovery file.

Options: [-contextMaze (generate context patterns)]
