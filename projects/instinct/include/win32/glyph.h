...
#define GK_VERSION_MINOR  28
#define GK_VERSION_PATCH  0
#define GK_VERSION_STR    "0.28"
#define GK_DATE_STR       "2005-06-27"
 ...
 */
GLYPH_DECLSPEC GLYPH_FACE* _gk_load_face_from_file ( const char* const fname, const int face_index, const int header_version, const int gk_header_target );

#define gk_load_face_from_file(a,b)  _gk_load_face_from_file(a,b,GK_MAKE_VERSION(GK_VERSION_MAJOR,GK_VERSION_MINOR,GK_VERSION_PATCH),GLYPH_TARGET)
 ...
 */
GLYPH_DECLSPEC GLYPH_FACE* _gk_load_face_from_memory ( const unsigned char* const data, const int size, const int face_index, const int header_version, const int gk_header_target );

#define gk_load_face_from_memory(a,b,c)  _gk_load_face_from_memory(a,b,c,GK_MAKE_VERSION(GK_VERSION_MAJOR,GK_VERSION_MINOR,GK_VERSION_PATCH),GLYPH_TARGET)
 ...
 */
GLYPH_DECLSPEC int gk_face_has_character ( GLYPH_FACE* const face, const unsigned code );

/*
 * This function checks if the face has character 'code'
 * among its own characters, without remapping.
 */
GLYPH_DECLSPEC int gk_face_has_own_character ( GLYPH_FACE* const face, const unsigned code );

/*
 * Remapping
 */
GLYPH_DECLSPEC void gk_remap_character ( GLYPH_FACE* const face1, const unsigned code1, GLYPH_FACE* const face2, const unsigned code2 );

GLYPH_DECLSPEC void gk_unmap_character ( GLYPH_FACE* const face, const unsigned code );

GLYPH_DECLSPEC void gk_remap_range ( GLYPH_FACE* const face1, const unsigned code1, GLYPH_FACE* const face2, const unsigned code2, const unsigned range_size );

GLYPH_DECLSPEC void gk_unmap_range ( GLYPH_FACE* const face, const unsigned code, const unsigned range_size );
 ...
 * This function returns 0 on failure.
 */
GLYPH_DECLSPEC GLYPH_KEEP* gk_create_keeper ( const unsigned max_glyphs, const unsigned max_memory );
 ...
 */
GLYPH_DECLSPEC GLYPH_REND* gk_create_renderer ( GLYPH_FACE* const face, GLYPH_KEEP* const keeper );
 ...
 */
GLYPH_DECLSPEC void gk_rend_set_keeper ( GLYPH_REND* const rend, GLYPH_KEEP* const new_keeper );
 ...
 * anything.
 */
GLYPH_DECLSPEC void gk_rend_set_face ( GLYPH_REND* const rend, GLYPH_FACE* const new_face );

/*
 * Sets new text size - size of EM square, in 1/64th of a pixel.
 * Returns 1 on success, 0 on failure.
 */
GLYPH_DECLSPEC int gk_rend_set_size_subpixel ( GLYPH_REND* const rend, const unsigned new_hsize, const unsigned new_vsize );

/*
 * Sets new text size in integer pixels.
 * Returns 1 on success, 0 on failure.
 */
GLYPH_DECLSPEC int gk_rend_set_size_pixels ( GLYPH_REND* const rend, const unsigned new_pixel_hsize, const unsigned new_pixel_vsize );

/*
 * Sets new angle in radians.
 */
GLYPH_DECLSPEC void gk_rend_set_angle ( GLYPH_REND* const rend, const double new_text_angle );
 ...
 */
GLYPH_DECLSPEC void gk_rend_set_undefined_char ( GLYPH_REND* const rend, const unsigned new_undefined_char );
 ...
 */
GLYPH_DECLSPEC void gk_rend_set_error_char ( GLYPH_REND* const rend, const unsigned new_error_char );
 ...
 */
GLYPH_DECLSPEC int gk_rend_has_character ( const GLYPH_REND* const rend, const unsigned code );

/*
 * Returns 1, if renderer can render a non-empty glyph for character 'code',
 * otherwise returns 0.
 */
GLYPH_DECLSPEC int gk_rend_has_glyph ( GLYPH_REND* const rend, const unsigned code );
 ...
 */
GLYPH_DECLSPEC void gk_rend_set_text_alpha_color ( GLYPH_REND* const rend, const unsigned alpha_color );

GLYPH_DECLSPEC unsigned gk_rend_get_text_alpha_color ( const GLYPH_REND* const rend );

/*
 * Setting color and alpha separately.
 */
GLYPH_DECLSPEC void gk_rend_set_text_color_rgb ( GLYPH_REND* const rend, const unsigned char r, const unsigned char g, const unsigned char b );
...
GLYPH_DECLSPEC void gk_rend_set_text_alpha ( GLYPH_REND* const rend, const unsigned char alpha );

GLYPH_DECLSPEC unsigned gk_rend_get_text_alpha ( const GLYPH_REND* const rend );

/*
 * Setting and checking background color.
 */
GLYPH_DECLSPEC void gk_rend_set_back_color ( GLYPH_REND* const rend, const int new_back_color );
...
GLYPH_DECLSPEC void gk_char_advance ( GLYPH_REND* const rend, const unsigned unicode, int* const adv_x, int* const adv_y );
 ...
 */
GLYPH_DECLSPEC void gk_text_size_utf8 ( GLYPH_REND* const rend, const char* const text, int* const width, int* const height );
GLYPH_DECLSPEC void gk_text_size_utf16 ( GLYPH_REND* const rend, const unsigned short* const text, int* const width, int* const height );
GLYPH_DECLSPEC void gk_text_size_utf32 ( GLYPH_REND* const rend, const unsigned* const text, int* const width, int* const height );
 ...
 */
GLYPH_DECLSPEC void gk_text_advance_subpixel_utf8 ( GLYPH_REND* const rend, const char* const text, int* const adv_x, int* const adv_y );
...
GLYPH_DECLSPEC void gk_text_advance_subpixel_utf32 ( GLYPH_REND* const rend, const unsigned* const text, int* const adv_x, int* const adv_y );
...
GLYPH_DECLSPEC void gk_precache_range ( GLYPH_REND* const rend, const unsigned range_start, const unsigned range_end );

GLYPH_DECLSPEC void gk_precache_set_utf8 ( GLYPH_REND* const rend, const char* const char_set );

GLYPH_DECLSPEC void gk_precache_set_utf16 ( GLYPH_REND* const rend, const unsigned short* const char_set );

GLYPH_DECLSPEC void gk_precache_set_utf32 ( GLYPH_REND* const rend, const unsigned* const char_set );
 ...
 */
GLYPH_DECLSPEC void gk_put_char ( GLYPH_TARGET_SURFACE* const bmp, GLYPH_REND* const rend, const unsigned unicode, const int x, const int y );

/*
 * Outputs a character so that it's center is at (x,y).
 */
GLYPH_DECLSPEC void gk_put_char_center ( GLYPH_TARGET_SURFACE* const bmp, GLYPH_REND* const rend, const unsigned unicode, const int x, const int y );
 ...
 * the next character.
 */
GLYPH_DECLSPEC void gk_render_char ( GLYPH_TARGET_SURFACE* const bmp, GLYPH_REND* const rend, const unsigned unicode, int* const pen_x, int* const pen_y );

GLYPH_DECLSPEC void gk_render_char_center ( GLYPH_TARGET_SURFACE* const bmp, GLYPH_REND* const rend, const unsigned unicode, const int x, const int y );


/*
 *
 */
GLYPH_DECLSPEC void gk_render_line_utf8 ( GLYPH_TARGET_SURFACE* const bmp, GLYPH_REND* const rend, const char* const text, const int pen_x, const int pen_y );

GLYPH_DECLSPEC void gk_render_line_utf16 ( GLYPH_TARGET_SURFACE* const bmp, GLYPH_REND* const rend, const unsigned short* const text, const int pen_x, const int pen_y );

GLYPH_DECLSPEC void gk_render_line_utf32 ( GLYPH_TARGET_SURFACE* const bmp, GLYPH_REND* const rend, const unsigned* const text, const int pen_x, const int pen_y );
...
GLYPH_DECLSPEC GLYPH_TEXTURE *gk_create_texture( GLYPH_REND *rend, int rangeStart, int rangeLength );

GLYPH_DECLSPEC void gk_send_texture_to_gpu( GLYPH_TEXTURE *texture );

GLYPH_DECLSPEC void gk_render_line_gl_utf8( GLYPH_TEXTURE *texture, const char *text, int x, int y );
