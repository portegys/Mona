...
# ----------------------------------------------------------------------
global .RootDir
source ${.RootDir}/Src/button.tcl
source ${.RootDir}/Src/entry.tcl
source ${.RootDir}/Src/listbox.tcl
source ${.RootDir}/Src/menu.tcl
source ${.RootDir}/Src/scale.tcl
source ${.RootDir}/Src/scrlbar.tcl
source ${.RootDir}/Src/text.tcl
